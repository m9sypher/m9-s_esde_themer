...
---
Getting started
Open `m9-theme-editor.html` in Chrome or Edge — real folder access needs the File System Access API. (Firefox/Safari can still use Paste XML + Export download instead.)
Click Open ES-DE themes folder to browse a real theme, or Paste XML to work on a snippet without touching disk.
For full previews with real game data: also open your ROMs/gamelists folder and your downloaded_media folder.
...
This tool is free to use. If you reuse, modify, or re-release it (or a derivative of it), please credit @m9sypher — a simple mention is all that's asked.
...
Twitch: twitch.tv/M9sypheR
YouTube: youtube.com/@m9sypher
Kick: kick.com/m9sypher
TikTok: tiktok.com/@m9sypher
Ko-fi: ko-fi.com/m9sypher/shop — completely optional, always appreciated
